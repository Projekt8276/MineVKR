...
JNIEXPORT void JNICALL Java_com_helixd2s_jivix_JiviXBase_initializeGL__J(JNIEnv* env, jclass cls, jlong arg0) {
    jthrowable exc = NULL;
    try {
...
JNIEXPORT void JNICALL Java_com_helixd2s_jivix_JiviXBase_initializeGL__(JNIEnv* env, jclass cls) {
    jthrowable exc = NULL;
    try {
        vkt::initializeGL();
    } catch (...) {
